...
namespace AlexList
{
    public class AlexList<T>
    {
        ...
        public void Sort()
        {
            ...
            do
            {
                ...
                for (int counter = 0; counter < _elementsArray.Length - 1; counter++)
                {
                    ...
                    {
                        Insert(_elementsArray[counter + 1], counter);
                        RemoveAt(counter + 2);
        ...
        {
            T[] interim_elementsArray = new T[newSize];

            if (_elementsArray.Length > 0)
            {
                if (_elementsArray.Length < newSize || _elementsArray.Length == newSize)
                {
                    for (int counter = 0; counter < _elementsArray.Length; counter++)
                        interim_elementsArray[counter] = _elementsArray[counter];
                }
            ...
            _elementsArray = interim_elementsArray;
        }
